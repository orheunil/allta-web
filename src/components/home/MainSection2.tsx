...
export const MainSection2 = () => {
  return (
    <section className="flex flex-col items-center w-full h-full px-[20px] lg:px-[80px] bg-back4">
      <div className="flex flex-col md:flex-row justify-center items-center w-full max-w-[375px] md:max-w-[736px] lg:max-w-[1080px] pt-[240px] gap-[48px] md:gap-[80px] lg:gap-[150px]">
